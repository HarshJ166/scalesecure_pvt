...
function Header() {
  ...
  return (
    <header className="w-full flex flex-row itmes-center justify-between">
      <div className="w-3/4 flex flex-row space-x-5 items-center">
        <Link to="/">
          <img src={Logo} alt="Logo" className="h-7" />
        </Link>
        <div className="flex flex-row items-center justify-between space-x-5 mt-4">
