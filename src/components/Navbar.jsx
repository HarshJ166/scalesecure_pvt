    ...
    <div className="font-para bg-[#D5E3F8] ">
      ...
      >
        <div className="items-center gap-x-3 px-4 max-w-screen-xl mx-auto md:flex md:justify-center md:px-8">
          ...
          <div
            className={`nav-menu flex-1 pb-3 mt-8 md:block md:pb-0 md:mt-4 ${
              state ? "block" : "hidden"
            }`}
          >
                ...
                {navigation.map((item, idx) => {
                  return (
                    ...
                    >
                      {item.isDropdown ? (
                        <button
                          className="w-full flex items-center justify-between gap-1 text-gray-700 hover:text-white rounded-md bg-[#c3d3dd] hover:bg-[#03193D] px-2 py-2"
                          onMouseEnter={() => {
                            if (!state) {
                              setdropdownState({
                                idx,
                        ...
                        <Link
                          to={item.path}
                          className="block text-gray-700 hover:text-white rounded-md bg-[#c3d3dd] hover:bg-[#03193D] px-2 py-2"
                        >
                          {item.title}
                        </Link>
                      )}
      ...
      {state ? (
        <div
          className="z-40 relative top-0 w-screen md:hidden"
