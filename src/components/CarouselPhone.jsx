  ...
  return (
    <div className="relative w-full h-screen justify-center items-center">
      ...
      <div className="flex justify-center">
        <div className="flex h-full justify-center items-center absolute px-4 py-7 flex-row ease-in-out">
          <div className="h-full bg-[#D8E7F0] flex items-center justify-center flex-col rounded-2xl p-3">
            <div className="">
              <img
            ...
            <div className="flex flex-col items-center justify-center ">
              <div>
                <h2 className="text-2xl text-gray-800">Hello World</h2>
              </div>
              <div>
                <p>
