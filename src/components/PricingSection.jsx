  ...
  return (
    <div className="flex justify-center items-center">
      <section className="flex flex-col">
        <div className="max-w-screen-2xl mx-auto px-4 text-black md:px-8">
          <div className="relative max-w-2xl mx-auto sm:text-center"></div>
          <div className="mt-16 justify-center gap-6 sm:grid sm:grid-cols-2 sm:space-y-0 lg:grid-cols-3">
            {plans.map((item, idx) => (
              <div
                ...
                style={
                  item.isMostPop
                    ? { transform: "translateY(-.75rem) scale(1.03)" }
                    : {}
                }
              >
                {item.isMostPop ? (
