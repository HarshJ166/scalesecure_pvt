...
import { Label } from "../components/ui/Register/Label";
import { Input1 } from "../components/ui/Register/Input1";
        ...
        <div className="max-w-md w-full mx-auto md:mx-0 rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-[#D8E7F0] dark:text-gray-800">
          ...
          <form onSubmit={handleSubmit} className=" mt-4 w-full">
            <LabelInputContainer className="mb-4 mt-4">
              ...
              <Input1 id="firstname" placeholder="First Name" type="text" />
            </LabelInputContainer>

            <LabelInputContainer className="mb-4 mt-4">
              <Label htmlFor="LastName">Last Name</Label>
              <Input1 id="lastname" placeholder="Last Name" type="text" />
            </LabelInputContainer>

            <LabelInputContainer className="mb-4 mt-4">
              <Label htmlFor="email">Work Email Address</Label>
              <Input1 id="email" placeholder="email@company.com" type="email" />
            </LabelInputContainer>
